...
var createFunctionTree = function (context, obj, tree, url) {
    _.each(tree.functions, function (fn) {
        obj[fn.verb.toLowerCase()] = function (json, cb) {
            return context._request(fn.verb, url, json, cb);
        };
    });
        ...
        if (subtree.paths.hasOwnProperty(PARAM)) {
            obj[prefix] = function () {
                ...
                assert(_.all(args, function (arg) {
                    // if it losely equals the string version of itself,
                    // its good enough for our purposes
                    return String(arg) == arg; // jshint ignore:line
...
TravisClient.prototype._authenticateAccessToken = function (msg, callback) {
    ...
    this._request('GET', '/users', msg, function (err) {
